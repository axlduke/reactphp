...
export const Actions = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/react-php/php-react/all-users.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertUser = (newUser) => {
    fetch("http://localhost/react-php/php-react/add-user.php", {
      method: "POST",
      headers: {
  ...
  const updateUser = (userData) => {
    fetch("http://localhost/react-php/php-react/update-user.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteUser = (theID) => {
    ...
    fetch("http://localhost/react-php/php-react/delete-user.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
